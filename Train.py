...
if __name__ == '__main__':
    ...
    # print("conv1 %g,conv2 %g,fc1 %g,fc2 %g" % (W_conv1,W_conv2,W_fc1,W_fc2)
    ...
    name = 'Train_data1/' + 'train_one_6'
    np.savez(name, Accuracy_1, Loss_1)

    # print(W_glob_1)
    # name = 'Local_model_1/' + 'five'
...
if __name__ == '__main__':
    ...
    name = 'Train_data2/' + 'train_two_6'
    np.savez(name, Accuracy, Loss)

    # print(W_glob)
    # name = 'Local_model/' + 'five'
